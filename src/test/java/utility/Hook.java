...
public class Hook {
	...
	public void setUpAppium() throws MalformedURLException
	{
		if ( Hook.platform == TestPlatform.Android) {
			...
			//要測試的APK路徑
			cap.setCapability(MobileCapabilityType.APP, "/Users/evan/Projects/My/Tdd/book/AppiumSample/app-debug.apk");
			//AppiumDriver位址
			...
			cap.setCapability(MobileCapabilityType.APP, "app.ipa");
